const GET_ROUNDS_API = "https://quotes-backend-api.herokuapp.com/get-rounds";
const GAMES_URL = "https://quotes-backend-api.herokuapp.com/games";
...
const renderEndPage = (user) => {
	...
	if (score === 0) {
		finalImage.src =
			"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.giphy.com%2Fmedia%2F3og0IJHMqlmPzy7sGs%2Fgiphy.gif&f=1&nofb=1";
	}
	if (score === 1) {
		finalImage.src =
			"https://images.mentalfloss.com/sites/default/files/styles/insert_main_wide_image/public/ice-cream-poop.png";
	}
	if (score === 2) {
		finalImage.src =
			"https://media.tenor.com/images/2a977f69d4adc7b6879b904763012cac/tenor.gif";
	}
	if (score === 3) {
		finalImage.src =
			"https://media.tenor.com/images/aa59ee31267aadab1fec222b537ace84/tenor.gif";
	}
	if (score === 4) {
		finalImage.src =
			"https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fcdn2.pu.nl%2Fmedia%2Fmisc2%2F7rjppjh.gif&f=1&nofb=1";
	}
	if (score === 5) {
	...
	if (score === 6) {
		finalImage.src =
			"https://media.tenor.com/images/74c5d5848cfceb38323c79bdb0d078e2/tenor.gif";
	}
	if (score === 7) {
		finalImage.src =
			"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.giphy.com%2Fmedia%2FZmdErsWqppgMo%2Fgiphy.gif&f=1&nofb=1";
	}
	if (score === 8) {
		finalImage.src =
			"https://media.tenor.com/images/f1cef839e5124661798cc567f5ca1aa3/tenor.gif";
	}
	if (score === 9) {
		finalImage.src =
			"https://media.tenor.com/images/1408360eeb8f880c1d9a2420dd34e492/tenor.gif";
	}
	if (score === 10) {
		finalImage.src =
			"https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.giphy.com%2Fmedia%2FTcdpZwYDPlWXC%2Fgiphy.gif&f=1&nofb=1";
	}
